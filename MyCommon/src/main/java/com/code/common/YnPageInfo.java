...
public class YnPageInfo implements Serializable {
	...
	public YnPageInfo(Integer reqeustPage) {
		initPageInfo(reqeustPage, DEAFULT_PAGE_SIZE, DEAFULT_PAGENO_STEP);
	}
	public YnPageInfo(Integer reqeustPage, Integer pageSize) {
		initPageInfo(reqeustPage, pageSize, DEAFULT_PAGENO_STEP);
	}
	public YnPageInfo(Integer reqeustPage, Integer pageSize, Integer pageNoStep) {
