...
public interface IBaseService<T> {
	 ...
	 */
	  ...
	  * @return
	  */
	 RemotePage queryPageByObject(T obj,YnPageInfo info);
	 /**
	  * 根据参数中不为空的属性查询列表，key对应dto中的属性
	  * @param id
	  * @return
	  */
	 RemotePage queryPageByParamNotEmpty(Map<String,Object> params,YnPageInfo info);
	 /**
	  * 根据参数查询列表，key对应dto中的属性
	  * @param id
	  * @return
	  */
	 RemotePage queryPageByParam(Map<String,Object> params,YnPageInfo info);
}
