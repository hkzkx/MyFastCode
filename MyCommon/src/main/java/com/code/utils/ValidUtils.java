...
public class ValidUtils {
	private static final String mobile = "^(130|131|132|133|134|135|136|137|138|139|145|147|150|151|152|153|155|156|157|158|159|170|176|177|178|180|181|182|183|184|185|186|187|188|189)[0-9]{8}$";
	...
	/**只能以字母开头,字母数字下划线组合,5-25位**/
	private static final String account="^[a-zA-Z]{1}([a-zA-Z0-9]|[_]){4,25}$";
	/** 手机号 */
	...
	public static void main(String[] args) {
		System.out.println(isYouanAccount("_aaj_2com"));
		System.out.println(isUserName("_aaj_2com"));
	}
}
