...
import com.code.common.YnPageInfo;
...
public class YnPageInterceptor implements Interceptor {	
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if(rowBounds == RowBounds.DEFAULT) { //没有分页信息RowBounds
			...
			YnPageInfo pageInfo = (YnPageInfo)metaStatement.getValue("delegate.boundSql.parameterObject.pageInfo");
			if(pageInfo == null) {
				return invocation.proceed();
			}
...
//			rowBounds = pageInfo.getPageInfo();
	...
	private boolean setRecordCount(Connection connection, MappedStatement mappedStatement, BoundSql boundSql, YnPageInfo pageInfo) {
