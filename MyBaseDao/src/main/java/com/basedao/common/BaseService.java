...
public abstract class BaseService<T> implements IBaseService<T> {
	...
	public RemotePage queryPageByObject(T obj, YnPageInfo info) {
	...
	public RemotePage queryPageByParam(Map<String, Object> params, YnPageInfo info) {
		info.setRecordCount(queryByParamCount(params));
		setLimit(params,info);
		return new RemotePage(getDao().queryPageByParam(params),info);
	}
	
	public void setLimit(final Map<String,Object> params,final YnPageInfo info){
