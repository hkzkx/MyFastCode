...
public class Main {
	...
	private static final String package_ = "com.code.{layer}.{module}"; // 根据命名约定，不可变
	private static final String remotePath = "D:/java/workspace/luna/MyRemote/src/main/java/"; // 业务存根代码生成的路径
	private static final String soaPath = "D:/java/workspace/luna/MySoa/src/main/java/"; // 远程服务代码生成的路径
	private static final String webPath = "D:/java/workspace/luna/MyWeb/src/main/java/"; // 应用代码生成的路径
	private static final String ftlPath = "D:/java/workspace/luna/MyWeb/src/main/webapp/WEB-INF/ftl/";//生成的 ftl from 存放位置 
	private static final String messagesPath = "D:/java/workspace/luna/MyWeb/src/main/resources/messages//";//生成的 校验出错时的信息 
		...
		while (System.in.read(bs) != -1) {
			...
			for (String tableName : tableNames) {
				...
				String sql = "select COLUMN_NAME,DATA_TYPE,COLUMN_KEY,COLUMN_COMMENT,COLUMN_DEFAULT,IS_NULLABLE from COLUMNS where table_name='"
						+ tableName + "' and table_schema='zkx'";
