...
import com.mmb.common.Constant;
import com.mmb.common.RemotePage;
//import com.mmb.controller.user.SitUserController;
...
//	private SitUserController sitUserController;
	...
	public void setUp() throws Exception {
		...
		msc = new MockServletContext(
				"file://D:/java/workspace/luna/MyWeb/src/main/webapp");
		context.setServletContext(msc);
		context.refresh();
		msc.setAttribute(
				WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE,
				context);
//		sitUserController = (SitUserController) context
//				.getBean("sitUserController");
	...
	public void testInsertServiceProductInfo() {
		...
		//
		// request.addParameter("deliveryType",
		// Constant.PRODUCT_DELIVERY_TYPE.DOOR2DOOR.code().toString());
		// request.addParameter("featureInfo", "k:v&k:v");
		// request.addParameter("isAutomaticShelves",
		// Constant.PRODUCT_AUTOMATIC_SHELVES.NO.code().toString());
		// request.addParameter("isProduct",
		// Constant.SERVICE_TYPE.PRODUCT.code().toString());
		// request.addParameter("isStoreHome",
		// Constant.COMMON_TYPE.NO.code().toString());
		// request.addParameter("productImgs",
		// "http://news.baidu.com/z/resource/r/image/2014-02-27/c35e6b70385a63bdd578dc30dd77876b.jpg");
		...
		// request.addParameter("serviceProductBasePrice.rentBeginTime",
		// "2014/11/11");

		HttpSession session = request.getSession();
		try {
//			ModelAndView mv = new AnnotationMethodHandlerAdapter().handle(
//					request, response, sitUserController);
