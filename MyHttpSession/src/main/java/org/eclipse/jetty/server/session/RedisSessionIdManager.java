...
import com.my.redis.PooledJedis;
...
public class RedisSessionIdManager extends AbstractSessionIdManager {
	...
	public void invalidateAll(String id) {
		...
		for (int i = 0; contexts != null && i < contexts.length; i++) {
			MySessionHandler sessionHandler = (MySessionHandler) ((ContextHandler) contexts[i])
					.getChildHandlerByClass(MySessionHandler.class);
